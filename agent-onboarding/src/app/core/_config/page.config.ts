export class PageConfig {
	public defaults: any = {
		...
		'hierarchy-template': { // <= add page URL
			page: { title: 'Hierarchy Template', desc: 'CRUD For Hierarchy Template' } // <= Page name and description
		},
		'individual-hierarchy': { // <= add page URL
			page: { title: 'Individual Hierarchy', desc: 'CRUD For Individual Hierarchy ' } // <= Page name and description
		},
		'parent-hierarchy': { // <= add page URL
			page: { title: 'Parent Hierarchy', desc: 'CRUD For Individual Hierarchy ' } // <= Page name and description
		},
		ngbootstrap: {
			accordion: {
